...
var _Navitem = require('./Navitem.jsx');

var _Navitem2 = _interopRequireDefault(_Navitem);

var _Posts = require('./Posts.jsx');

var _Posts2 = _interopRequireDefault(_Posts);

var _Wiki = require('./Wiki.jsx');
...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.state = { page: 'posts' };

		_this.onNavbar = _this.onNavbar.bind(_this);
		return _this;
	}

	_createClass(App, [{
		key: 'onNavbar',
		value: function onNavbar(page) {
		...
		value: function render() {
			...
			if (this.state.page == 'posts') {
				var postNumber = $('#post-id').val();
				content = _react2.default.createElement(_Posts2.default, { postNumber: postNumber });
			} else if (this.state.page == 'wiki') {
				content = _react2.default.createElement(_Wiki2.default, null);
			}
			var body = _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_Navitem2.default, { curPage: this.state.page, onclick: this.onNavbar, page: 'posts', pageTitle: 'Posts' }),
					_react2.default.createElement(_Navitem2.default, { curPage: this.state.page, onclick: this.onNavbar, page: 'wiki', pageTitle: 'Wiki' })
				),
				content
			);
...
},{"./Navbar.jsx":28,"./Navitem.jsx":29,"./Posts.jsx":30,"./Wiki.jsx":31,"react":26}],28:[function(require,module,exports){
'use strict';
...
var Navitem = function (_React$Component) {
	...
	_createClass(Navitem, [{
		...
		key: 'render',
		value: function render() {
			var navitemStyle = { cursor: 'pointer' };
			var className = 'navitem';
			if (this.props.curPage == this.props.page) className += ' active';
			return _react2.default.createElement(
				'span',
				{ style: navitemStyle, className: className, id: this.props.page, onClick: this.onClick },
...
var Posts = function (_React$Component) {
	...
	_createClass(Posts, [{
		key: 'render',
		value: function render() {
			if (this.props.postNumber > 0) {} else {}
			return _react2.default.createElement(
				'h2',
				null,
				'Blog'
...
},{"./App.jsx":27,"react":26,"react-dom":23}]},{},[32])
